<#
# Source       : https://github.com/Azure/RDS-Templates/blob/master/CustomImageTemplateScripts/CustomImageTemplateScripts_2024-03-27/InstallLanguagePacks.ps1
# Author       : Akash Chawla
...
[CmdletBinding()]
  Param (
        ...
        [System.String[]]$LanguageList="German (Germany)"
    )
