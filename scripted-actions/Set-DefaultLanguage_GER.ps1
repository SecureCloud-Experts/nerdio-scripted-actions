<#
# Source       : https://github.com/Azure/RDS-Templates/blob/master/CustomImageTemplateScripts/CustomImageTemplateScripts_2024-03-27/SetDefaultLang.ps1
# Author       : Akash Chawla
...
[CmdletBinding()]
  Param (
        ...
        [string]$Language=@("German (Germany)")
)
